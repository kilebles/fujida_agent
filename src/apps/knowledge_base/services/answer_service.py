...
Отвечай на вопросы пользователей строго по базе знаний (FAQ).
Если в контексте есть ответ, приведи его полностью.
Не придумывай ничего сверх того, что дано.
...
- Если упомянуты сокращения (например, "про макс"), выбери самую подходящую модель по алиасам.
"""
