...
def instructions_text() -> str:
    return (
        ...
        "Fujida — премиальный бренд автоэлектроники, в котором представлены лучшие видеорегистраторы, радар-детекторы и комбо-устройства для автомобилистов."
        "Помоги пользователю с вопросом, как опытный консультант. "
        "Если нет сведения о моделях - НЕ ПРИДУМЫВАЙ ОТСЕБЯТИНУ!"
        "Информацию о моделях не сокращай. "
